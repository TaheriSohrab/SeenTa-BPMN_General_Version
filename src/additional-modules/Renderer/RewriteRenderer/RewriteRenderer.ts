...
class RewriteRenderer extends BaseRenderer {
  ...
  constructor(
    ...
    const handlers = (this.handlers = {
      ...
      // 自定义节点的绘制
      'AOT:AOT': function (parentGfx, element, attr) {
        // 渲染外层边框
        const attrs = {
          fill: getFillColor(element, defaultFillColor),
          fillOpacity: defaultTaskOpacity,
        ...
        svgAttr(customIcon, {
          ...
          href: 'src/bpmn-icons/corner-icons/mikasa_corner.png'
        })
      ...
      'WallE:WallE': function (parentGfx, element, attr) {
        // 渲染外层边框
        const attrs = {
          fill: getFillColor(element, defaultFillColor),
          fillOpacity: defaultTaskOpacity,
        ...
        svgAttr(customIcon, {
          ...
          width: element.width,
          height: element.height,
          href: 'src/bpmn-icons/corner-icons/wall-e_corner.png'
        })
        svgAppend(parentGfx, customIcon)
        renderEmbeddedLabel(parentGfx, element, 'center-middle')
        attachTaskMarkers(parentGfx, element)
